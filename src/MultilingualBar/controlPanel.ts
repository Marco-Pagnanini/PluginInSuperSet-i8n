...
import barControlPanel from 'echarts-bar-control-panel';
    ...
    [
      {
        ...
        config: {
          ...
          description: t('Nome personalizzato della metrica in italiano (sostituisce SUM(...) nella legenda)'),
          default: '',
          renderTrigger: true,
        },
      },
    ...
    [
      {
        ...
        config: {
          ...
          description: t('Custom metric name in English (replaces SUM(...) in the legend)'),
          default: '',
          renderTrigger: true,
        },
      },
...
export default {
  ...
  controlPanelSections: [
    multilingualSection,
    metricLabelSection,
    ...barControlPanel.controlPanelSections,
  ],
};
